...
var CmdWire = &cobra.Command{
	Use:     "wire",
	Short:   "trux wire [wire.go path]",
	Long:    "trux wire [wire.go path]",
	Example: "trux wire cmd/server",
	Run: func(cmd *cobra.Command, args []string) {
		...
		if dir == "" {
			...
			default:
				...
				dir = bubbletea.BuildListTea("Which directory do you want to run?", wirePaths)
				dir = wirePath[dir]
			}
		}
		wire(dir)
